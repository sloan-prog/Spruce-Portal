...
// See laundry-send-out.js — matching is by semantic name, not q{id}_.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.log('LAUNDRY RETURN keys:', JSON.stringify(Object.keys(raw)));
    ...
    const row = {
      ...
      cleaner_name:    asText(pick(map, ['yourName', 'cleaner', 'cleanerName'])) || null,
      plan_type:       asText(pick(map, ['planType'])) || null,
      bag_count:       asInt(pick(map, ['numberOfBagsReturned', 'bagsReturned', 'numberOfBags', 'bags'])),
